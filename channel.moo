object CHANNEL
  ...
  property color (owner: HACKER, flags: "r") = "yellow";
  property is_muted (owner: HACKER, flags: "r") = 0;
  property muted_players (owner: HACKER, flags: "r") = [];
  property player_whitelist (owner: HACKER, flags: "r") = {PLAYER};
  property symbol (owner: HACKER, flags: "r") = "-";

  verb "nrtransmit transmit" (this none this) owner: HACKER flags: "rxd"
  ...
  verb format_msg (this none this) owner: HACKER flags: "rxd"
    return tostr($ansi:((this.color))("[", this.symbol, "][", $su:uppercase(this:name()), "]", " %msg"));
  endverb

  verb is_on_channel (this none this) owner: HACKER flags: "rxd"
    {dude} = args;
    return !(!(this in dude.channels));
  endverb

  verb can_join (this none this) owner: HACKER flags: "rxd"
    {dude} = args;
  ...
  verb why_cant_transmit (this none this) owner: HACKER flags: "rxd"
    {dude} = args;
    if (this.is_muted)
  ...
  verb muted_players (this none this) owner: HACKER flags: "rxd"
  ...
  verb player_title (this none this) owner: HACKER flags: "rxd"
    return "";
  endverb
endobject