object SERVER_OPTIONS
  ...
  property bg_ticks (owner: #2, flags: "rc") = 10000000;
  ...
  property fg_ticks (owner: #2, flags: "rc") = 10000000;
  ...
  property no_name_lookup (owner: #2, flags: "rc") = 1;
  ...
  property protect_chparents (owner: #2, flags: "rc") = 1;
  property protect_force_input (owner: #2, flags: "rc") = 1;
  property protect_read (owner: #2, flags: "rc") = 1;
