object #59
  ...
  property "_other_preps" (owner: #36, flags: "rc") = {"using", "at", "inside", "into", "on top of", "onto", "upon", "out of", "from inside", "underneath", "beneath", "about", "off of"};

  property "_short_preps" (owner: #36, flags: "rc") = {"with", "to", "in front of", "in", "on", "from", "over", "through", "under", "behind", "beside", "for", "is", "as", "off"};

  property "_all_preps" (owner: #36, flags: "rc") = {"with", "using", "at", "to", "in front of", "in", "inside", "into", "on top of", "on", "onto", "upon", "out of", "from inside", "from", "over", "through", "under", "underneath", "beneath", "behind", "beside", "for", "about", "is", "as", "off", "off of"};

  property "builtin_props" (owner: #2, flags: "r") = {"name", "r", "w", "f", "programmer", "wizard", "owner", "location", "contents", "last_move", "a"};

  property "error_names" (owner: #36, flags: "rc") = {"E_NONE", "E_TYPE", "E_DIV", "E_PERM", "E_PROPNF", "E_VERBNF", "E_VARNF", "E_INVIND", "E_RECMOVE", "E_MAXREC", "E_RANGE", "E_ARGS", "E_NACC", "E_INVARG", "E_QUOTA", "E_FLOAT", "E_FILE", "E_EXEC", "E_INTRPT"};

  property "error_list" (owner: #36, flags: "rc") = {E_NONE, E_TYPE, E_DIV, E_PERM, E_PROPNF, E_VERBNF, E_VARNF, E_INVIND, E_RECMOVE, E_MAXREC, E_RANGE, E_ARGS, E_NACC, E_INVARG, E_QUOTA, E_FLOAT, E_FILE, E_EXEC, E_INTRPT};

  property "prepositions" (owner: #36, flags: "rc") = {"with/using", "at/to", "in front of", "in/inside/into", "on top of/on/onto/upon", "out of/from inside/from", "over", "through", "under/underneath/beneath", "behind", "beside", "for/about", "is", "as", "off/off of"};
  ...
  verb "commentify" (this none this) owner: #2 flags: "rxd"
  ...
  verb "parse_sysobj_map" (this none this) owner: #2 flags: "rxd"
  ...
  verb "uncommentify" (this none this) owner: #2 flags: "rxd"
