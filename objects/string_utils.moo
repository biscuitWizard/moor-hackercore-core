object #20
  ...
  property IRREGULAR_PLURAL_RULES (owner: #2, flags: "r") = [
    "anathemata" -> "anathema",
    "are" -> "is",
    "axes" -> "axe",
    "canvases" -> "canvas",
  ...
  property IRREGULAR_RULES (owner: #2, flags: "r") = [
    "anathema" -> "anathemata",
    "axe" -> "axes",
    "canvas" -> "canvases",
    "carve" -> "carves",
  ...
  property IRREGULAR_SINGULAR_RULES (owner: #2, flags: "r") = [
    "anathema" -> "anathemata",
    "axe" -> "axes",
    "canvas" -> "canvases",
    "carve" -> "carves",
  ...
  property PLURALIZATION_RULES (owner: #2, flags: "r") = [
  ...
  property SINGULARIZATION_RULES (owner: #2, flags: "r") = [
  ...
  property UNCOUNTABLE_RULES (owner: #2, flags: "r") = {
    "adulthood",
    "advice",
    "agenda",
    "aid",
  ...
  property exit_directions (owner: #2, flags: "r") = [
    "a" -> "aft",
    "d" -> "down",
    "e" -> "east",
    "f" -> "fore",
