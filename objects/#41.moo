object #41
  ...
  property "genders" (owner: #36, flags: "rc") = {"neuter", "male", "female", "either", "Spivak", "splat", "plural", "egotistical", "royal", "2nd"};
  ...
  property "pq" (owner: #36, flags: "rc") = {"its", "his", "hers", "his/hers", "eirs", "h*s", "theirs", "mine", "ours", "yours"};

  property "pr" (owner: #36, flags: "rc") = {"itself", "himself", "herself", "(him/her)self", "emself", "h*self", "themselves", "myself", "ourselves", "yourself"};
  ...
  property "pqc" (owner: #36, flags: "rc") = {"Its", "His", "Hers", "His/Hers", "Eirs", "H*s", "Theirs", "Mine", "Ours", "Yours"};

  property "prc" (owner: #36, flags: "rc") = {"Itself", "Himself", "Herself", "(Him/Her)self", "Emself", "H*self", "Themselves", "Myself", "Ourselves", "Yourself"};
