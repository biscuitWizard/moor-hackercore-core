object #43
  ...
  property "months" (owner: #36, flags: "rc") = {"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"};

  property "monthabbrs" (owner: #36, flags: "rc") = {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};

  property "zones" (owner: #36, flags: "rc") = {{{"est", "edt", "Massachusetts", "MA"}, 10800}, {{"cst", "cdt"}, 7200}, {{"mst", "mdt"}, 3600}, {{"pst", "pdt", "California", "CA", "Lambda"}, 0}, {{"gmt"}, 28800}};

  property "time_units" (owner: #36, flags: "rc") = {{31536000, "year", "years", "yr", "yrs"}, {2628000, "month", "months", "mo", "mos"}, {604800, "week", "weeks", "wk", "wks"}, {86400, "day", "days", "dy", "dys"}, {3600, "hour", "hours", "hr", "hrs"}, {60, "minute", "minutes", "min", "mins"}, {1, "second", "seconds", "sec", "secs"}};
