object #35
  ...
  override "description" = {"An object useful for pronoun substitution for switching between third and second person.  See `help $you' for details."};
