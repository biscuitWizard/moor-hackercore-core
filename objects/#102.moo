object ANSI Options
  ...
  property show_approximate_256 (owner: #98, flags: "rc") = {
  ...
  property show_backgrounds (owner: #98, flags: "rc") = {
  ...
  property show_truecolor (owner: #98, flags: "r") = {
