object #3
  ...
  verb "acceptable" (this none this) owner: #2 flags: "rxd"
    what = args[1];
    return this:is_unlocked_for(what) && (this:free_entry(@args) || what.owner == this.owner || (typeof(this.residents) == LIST && (what in this.residents || what.owner in this.residents)));
  endverb
