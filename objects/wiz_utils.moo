object #24
  ...
  property new_core_message (owner: #2, flags: "r") = {
    "Getting Started with your HackerCore MOO",
    "========================================",
    "",
    "Thank you for choosing HackerCore! HackerCore is derived from ToastCore, so similarities are no coincidence.",
    "",
    "Initial Setup Notes",
    "-------------------",
    "",
    ...
    "-----",
    "",
    "By default, ToastCore runs with byte-based quota, an in-DB quota system, limiting users by total database space as opposed to total objects.  You'll need to do two things:",
    ...
    "",
    "If you prefer the quota system documented in the LambdaMOO / ToastStunt Programmer's Manual, directly supported by the server, you can enable object-based quota:",
    ...
    "",
    "No code to automatically grant programmer bits is included with ToastCore.",
    "",
    "Making Wizards",
    "--------------",
    "",
    ...
    "-------------------------------------------------------------------",
    "",
    "Good luck with your new ToastCore database!",
    "",
    "Visit us at LambdaMOO: lambda.moo.mud.org 8888",
    "",
    "Join the international mailing list for MOO coders: https://groups.google.com/g/MOO-talk",
    "",
    "Join the ToastStunt / MOO Discord: https://discord.gg/JUz3zwZamW",
    "",
    "Do good things.",
    "",
    "The LambdaMOO Wizards",
    "[authored February 15, 1999]",
    "[edited April 24, 2024 for ToastCore]"
  };
